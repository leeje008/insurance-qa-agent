"""crawler.sources.kyobo - 교보생명 약관 크롤러.

교보생명 공시실에서 생명보험 약관 PDF를 수집한다.
JSP 기반 사이트.
...
BASE_URL = "https://www.kyobo.co.kr"
    ...
    async def fetch_product_list(self) -> list[ProductMeta]:
        ...
        async with async_playwright() as pw:
            ...
            disclosure_urls = [
                ...
                f"{BASE_URL}/dsgn/prd/disclosure/clause.do",
                f"{BASE_URL}/disclosure/clause.jsp",
            ]
        ...
        logger.info("교보생명 약관 총 %d건 수집 완료", len(products))
        return products
